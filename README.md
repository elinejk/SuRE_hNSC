...
### 6. Validation
Contains the scripts to
- obtain p-values for the SNPs in the MPRA validation library;
- compare emVars and control SNPs to published MPRAs performed in neural stem/progenitor cells.
...
**9.1 LDSC:** contains all the scripts used to 
- run LDSC;
- generate the plots showing the Enrichment. 

**9.2 emVars in loci:** contains all the scripts used to
...
**9.3 PAINTOR fine-mapping:** contains the scripts used to 
- perform fine-mapping using PAINTOR;
- create a plot to show tissue expression of a specific gene.

**9.4 Distance to the lead SNP:** contains all the scripts used to
