...
*putative targets* \
**overlap_with_HiC.R:** this script was used to annotate hNSC emVars with HiC data for excitatory neurons generated by Song et al. 2019 (PMID: 31367015), which was used to assign putative targets to hNSC emVars.
