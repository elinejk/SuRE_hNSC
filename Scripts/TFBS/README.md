...
**100325_SuRE_figures.R - Correlation plot section** shows the mean correlation between emVar/control fraction and nucleotide conservation for each position within each TFBS (corresponds to figure 2D and S4C in the manuscript).
