...
for (tissue in tissues){
  ...
  print(paste0("analysis of emvars or null variants: ", anatype))
  print(paste0("printing summary information for ", tissue))
  #print(paste0("hNSC had ", nrow(a), " controls tested as eQTL for ", tissue))
  print(paste0(nrow(b), " variants were significant eQTLs in ", tissue))
  print(paste0(nrow(d), " variants and significant eQTLs have the same effect direction in ", tissue))
  print("[[[[]]]]")
