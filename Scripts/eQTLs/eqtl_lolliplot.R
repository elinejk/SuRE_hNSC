...
all <- all %>%
	...
	all$variant_id %in% raqtls$variant_id ~ "emVar", 
...
all$color <- ifelse(all$tested == "SuRE_tested", "#74737A", ifelse(all$tested == "emVar", "black", "#cccccc"))			
...
pdf("/gpfs/home6/ekoornstra/resources/eQTLs/fibroblasts_RERE_lollipopplot_19062024.pdf")
