...
#tissues <- c("Hypothalamus", "Hippocampus", "Putamen_basal_ganglia", "Caudate_basal_ganglia",
#             "Spinal_cord_cervical_c-1", "Cerebellar_Hemisphere", "Substantia_nigra")
...
print(paste0("number of controls in file: ", nrow(raqtl)))
...
for (tissue in tissues){
  ...
  print(paste0("analysis of hNSC raqtls: ", anatype))
  ...
  print(paste0(nrow(d), " raqtlss and significant eQTLs have the same effect direction in ", tissue))
  print("[[[[]]]]")
